...
window.setInterval(doInverseSpinZeroPitch,150);});$(function(){$(".typed").typed({strings:['Me',"Kamol","Coder","good conversationalist ","Python nedoпрораммист","Learn Python / Html"],typeSpeed:100,loop:true,cursorChar:"|",});});
